    ...
    */
    ...
    public void get(){
        ...
        spec.pathParams("first","todos"
                ,"second",198);
        // Set Expected
        // DIFFERENT WAYS OF SETTING THE EXPECTED DATA
        //1st way: using Reusable method to create map
        Map<String,Object> expectedData1 = jsonPlaceHolderMapper(10,"quis eius est sint explicabo",true);
        //2nd way: using Pojo class and its object
       ...
       */
        ...
        //3rd way: using ObjectMapper and Map (convertJsonToJava() method is reusable method => ObjectMapper().readValue())
        // NOTE: ObjectMapper option needs String -- so we learned different ways of creating Strings

        Map<String,Object> expectedDataMap = convertJsonToJava(expectedStr , HashMap.class );

        //3rd way: using ObjectMapper and Pojo (convertJsonToJava() method is reusable method => ObjectMapper().readValue())
