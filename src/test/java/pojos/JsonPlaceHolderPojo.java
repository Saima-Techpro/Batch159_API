...
public class JsonPlaceHolderPojo {
    /*
            POJO ------> Plain Old Java Object
                ...
                1)  Create all private variables (Encapsulation)
     ...
     */
    //  1)  Create all private variables (use wrapper class for data type so it can handle if any value is null)
    private Integer userId;
    private String title;
    private Boolean completed;
    //   2)  Create Constructors with all parameters and without parameters
    public JsonPlaceHolderPojo() {  // Constructor without parameters
    }
    public JsonPlaceHolderPojo(Integer userId, String title, Boolean completed) {  // Constructor with all parameters
        this.userId = userId;
        this.title = title;
